    ...
    <footer className="bg-[#1a1a1a] text-white/40 py-16 border-t border-white/5">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col items-center md:items-start gap-2">
          <span className="font-serif text-xl text-white">THE ELEPHANT</span>
          <span className="text-[10px] tracking-widest uppercase">Productions • Chennai</span>
          <span className="text-xs mt-4">© 2024 The Elephant Productions. by Strucureo</span>
        </div>
